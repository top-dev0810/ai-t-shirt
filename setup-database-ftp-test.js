...
async function setupDatabase() {
    ...
    try {
        ...
        // Step 4: Create admin_users table (WITHOUT password_hash field)
        console.log('👑 Creating admin_users table (simplified for FTP testing)...');
        await connection.execute(`
            CREATE TABLE IF NOT EXISTS admin_users (
                ...
                account_state ENUM('active', 'inactive', 'suspended') DEFAULT 'active',
                created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                INDEX idx_email (email),
        ...
        `);
        console.log('✅ Admin_users table created (no password field)');
        ...
        // Step 11: Insert admin user (Nitin) - WITHOUT password_hash
        console.log('👤 Creating admin user (Nitin) - simplified for testing...');
        await connection.execute(`
            INSERT INTO admin_users (username, email, role, is_active, account_state) 
            VALUES ('nitin', 'nitin@bandadda.com', 'admin', 1, 'active')
        ...
        `);
        console.log('✅ Admin user (Nitin) created - no password required');
        ...
        console.log('🎉 FTP Test Database setup finished successfully!');
        ...
        console.log('👤 Admin user: nitin@bandadda.com (no password required)');
        console.log('🔧 Ready for FTP image storage testing!');
